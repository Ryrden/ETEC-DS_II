...
container" method="post" action="desvioCompostoAction.php">
                ...
                <input class="w3-input w3-border w3-light-grey" name="txtN1" type=s"number">
                <label class="w3-text-teal"><b>Nota 2</b></label>
                <input class="w3-input w3-border w3-light-grey" name="txtN2" type="number">
                <label class="w3-text-teal"><b>Nota 3</b></label>
                <input class="w3-input w3-border w3-light-grey" name="txtN3" type="number">
                <br>
